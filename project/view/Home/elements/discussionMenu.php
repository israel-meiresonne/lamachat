...
?>
<a data-menuDiscuId="<?= $discuId ?>" href="javascript:void(0)" class="w3-bar-item w3-button w3-border-bottom test w3-hover-light-grey" onclick="openMail('<?= $discuId ?>');w3_close();readMessage('<?= $discuId ?>');">
